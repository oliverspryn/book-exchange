...
require_once(dirname(dirname(dirname(dirname(dirname(dirname(dirname(__FILE__))))))) . "/wp-blog-header.php");
require_once(dirname(dirname(dirname(dirname(dirname(dirname(dirname(__FILE__))))))) . "/wp-includes/pluggable.php");
require_once(dirname(dirname(dirname(dirname(dirname(dirname(dirname(__FILE__))))))) . "/wp-includes/user.php");
require_once(dirname(dirname(dirname(__FILE__))) . "/APIs/IndexDen.php");
require_once(dirname(dirname(dirname(__FILE__))) . "/APIs/Cloudinary.php");
require_once(dirname(dirname(dirname(__FILE__))) . "/display/Book.php");
require_once(dirname(dirname(dirname(__FILE__))) . "/emails/Email_Buyer.php");
require_once(dirname(dirname(dirname(__FILE__))) . "/emails/Email_Merchant.php");
require_once(dirname(dirname(dirname(__FILE__))) . "/exceptions/Login_Failed.php");
require_once(dirname(dirname(dirname(__FILE__))) . "/exceptions/Validation_Failed.php");
